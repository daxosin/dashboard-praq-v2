...
export const GridIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const DocIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const ZapIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const TriangleIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const TruckIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const MsgIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const BarChartIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const ClipboardIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const XMarkIcon: React.FC<IconProps> = ({ size = 16, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
...
export const BellIcon: React.FC<IconProps> = ({ size = 18, className = "" }) => (
  <svg
    width={size}
    height={size}
    fill="none"
